...
const dreamHolidayCards = [
  {
    ...
    image: "https://images.unsplash.com/photo-1588598198321-9735fd52455b?q=85&w=1200&auto=format&fit=crop", // Sigiriya rock climb
    href: "/experiences",
    isExternal: false,
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1488646953014-85cb44e25828?q=85&w=1200&auto=format&fit=crop", // Travel specialist couple
    href: "/travel-agents",
    isExternal: false,
  ...
  {
    id: 3,
    title: "Apply Sri Lankan Visa Online",
    tagline: "Official Immigration & ETA Portal",
    image: "https://images.unsplash.com/photo-1569154941061-e231b4725ef1?q=85&w=1200&auto=format&fit=crop", // Passport at airport
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?q=85&w=1200&auto=format&fit=crop", // Airplane in blue sky & clouds
    href: "/plan-your-trip#flights",
    isExternal: false,
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1566073771259-6a8506099945?q=85&w=1200&auto=format&fit=crop", // Luxury veranda overlooking jungle
    href: "/accommodation",
    isExternal: false,
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1510312305653-8ed496efae75?q=85&w=1200&auto=format&fit=crop", // Tents on mountain ridge
    href: "/experiences",
    isExternal: false,
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 pb-4 border-b border-brandDark/10">
          <div className="max-w-3xl space-y-3">
            ...
            <p className="text-base sm:text-lg text-brandDark/75 leading-relaxed font-sans pt-1">
              Each day on this island promises new experiences, discoveries, and life-long memories. With so much to do, let us help you with these official resources created just for you!
            </p>
          </div>
